...
from robot_navigation.utils import TryExcept
from robot_navigation.utils.dataloaders import exif_transpose, letterbox
...
from robot_navigation.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from robot_navigation.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from robot_navigation.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from robot_navigation.export import export_formats
        from robot_navigation.utils.downloads import is_url

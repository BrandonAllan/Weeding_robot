...
from robot_navigation.utils import TryExcept, emojis
from robot_navigation.utils.downloads import curl_download, gsutil_getsize
from robot_navigation.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from robot_navigation.models.common import AutoShape, DetectMultiBackend
...
def strip_optimizer(f="best.pt", s=""):
    ...
    Example: from robot_navigation.utils.general import *; strip_optimizer()
    """

...
from robot_navigation.utils.general import LOGGER, colorstr, cv2
from robot_navigation.utils.loggers.clearml.clearml_utils import ClearmlLogger
from robot_navigation.utils.loggers.wandb.wandb_utils import WandbLogger
from robot_navigation.utils.plots import plot_images, plot_labels, plot_results
from robot_navigation.utils.torch_utils import de_parallel
...
try:
    if RANK in {0, -1}:
        ...
        from robot_navigation.utils.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from robot_navigation.utils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
